...
class ProgData(data.Dataset):
    def __init__(self, dataset_cfg=None,
        ...
        if state == 'train':
            ...
            self.survival_months = self.slide_data['train_survival_months'].dropna().reset_index(drop=True)
            self.censorship = self.slide_data['train_censorship'].dropna().reset_index(drop=True)
            self.case_id = self.slide_data['train_case_id'].dropna().reset_index(drop=True)
            self.label = self.slide_data['train_disc_label'].dropna().reset_index(drop=True)
        if state == 'val':
            self.data = self.slide_data['val_slide_id'].dropna().reset_index(drop=True)
            self.survival_months = self.slide_data['val_survival_months'].dropna().reset_index(drop=True)
            self.censorship = self.slide_data['val_censorship'].dropna().reset_index(drop=True)
            self.case_id = self.slide_data['val_case_id'].dropna().reset_index(drop=True)
            self.label = self.slide_data['val_disc_label'].dropna().reset_index(drop=True)
        if state == 'test':
            self.data = self.slide_data['test_slide_id'].dropna().reset_index(drop=True)
            self.survival_months = self.slide_data['test_survival_months'].dropna().reset_index(drop=True)
            self.censorship = self.slide_data['test_censorship'].dropna().reset_index(drop=True)
            self.case_id = self.slide_data['test_case_id'].dropna().reset_index(drop=True)
            self.label = self.slide_data['test_disc_label'].dropna().reset_index(drop=True)
